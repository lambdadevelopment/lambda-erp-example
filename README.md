...
|-------|-----------|------|
| Backend | `lambda-erp==0.1.23` | PyPI |
| Frontend | `@lambda-development/erp-core@^0.1.23` | npm |
...
```
lambda-erp-example/
  pyproject.toml          # lambda-erp==0.1.23  (the backend core)
  ...
  frontend/
    package.json          # @lambda-development/erp-core ^0.1.23 + its peers
