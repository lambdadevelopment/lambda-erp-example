...
|-------|-----------|------|
| Backend | `lambda-erp==0.1.22` | PyPI |
| Frontend | `@lambda-development/erp-core@^0.1.22` | npm |
...
```
lambda-erp-example/
  pyproject.toml          # lambda-erp==0.1.22  (the backend core)
  ...
  frontend/
    package.json          # @lambda-development/erp-core ^0.1.22 + its peers
