...
|-------|-----------|------|
| Backend | `lambda-erp==0.1.38` | PyPI |
| Frontend | `@lambda-development/erp-core@^0.1.38` | npm |
...
```
lambda-erp-example/
  pyproject.toml          # lambda-erp==0.1.38  (the backend core)
  ...
  frontend/
    package.json          # @lambda-development/erp-core ^0.1.38 + its peers
