...
|-------|-----------|------|
| Backend | `lambda-erp==0.1.26` | PyPI |
| Frontend | `@lambda-development/erp-core@^0.1.26` | npm |
...
```
lambda-erp-example/
  pyproject.toml          # lambda-erp==0.1.26  (the backend core)
  ...
  frontend/
    package.json          # @lambda-development/erp-core ^0.1.26 + its peers
