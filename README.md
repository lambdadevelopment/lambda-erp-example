...
|-------|-----------|------|
| Backend | `lambda-erp==0.2.0` | PyPI |
| Frontend | `@lambda-development/erp-core@^0.2.0` | npm |
...
```
lambda-erp-example/
  pyproject.toml          # lambda-erp==0.2.0  (the backend core)
  ...
  frontend/
    package.json          # @lambda-development/erp-core ^0.2.0 + its peers
