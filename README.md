...
|-------|-----------|------|
| Backend | `lambda-erp==0.1.11` | PyPI |
| Frontend | `@lambda-development/erp-core@^0.1.11` | npm |
...
```
lambda-erp-example/
  pyproject.toml          # lambda-erp==0.1.11  (the backend core)
  ...
  frontend/
    package.json          # @lambda-development/erp-core ^0.1.11 + its peers
