...
|-------|-----------|------|
| Backend | `lambda-erp==0.1.15` | PyPI |
| Frontend | `@lambda-development/erp-core@^0.1.15` | npm |
...
```
lambda-erp-example/
  pyproject.toml          # lambda-erp==0.1.15  (the backend core)
  ...
  frontend/
    package.json          # @lambda-development/erp-core ^0.1.15 + its peers
