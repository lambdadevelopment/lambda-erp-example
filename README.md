...
|-------|-----------|------|
| Backend | `lambda-erp==0.1.29` | PyPI |
| Frontend | `@lambda-development/erp-core@^0.1.29` | npm |
...
```
lambda-erp-example/
  pyproject.toml          # lambda-erp==0.1.29  (the backend core)
  ...
  frontend/
    package.json          # @lambda-development/erp-core ^0.1.29 + its peers
