...
|-------|-----------|------|
| Backend | `lambda-erp==0.6.5` | PyPI |
| Frontend | `@lambda-development/erp-core@^0.6.5` | npm |
...
```
lambda-erp-example/
  pyproject.toml          # lambda-erp==0.6.5  (the backend core)
  ...
  frontend/
    package.json          # @lambda-development/erp-core ^0.6.5 + its peers
