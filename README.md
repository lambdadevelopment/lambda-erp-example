...
|-------|-----------|------|
| Backend | `lambda-erp==0.1.27` | PyPI |
| Frontend | `@lambda-development/erp-core@^0.1.27` | npm |
...
```
lambda-erp-example/
  pyproject.toml          # lambda-erp==0.1.27  (the backend core)
  ...
  frontend/
    package.json          # @lambda-development/erp-core ^0.1.27 + its peers
