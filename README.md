...
|-------|-----------|------|
| Backend | `lambda-erp==0.1.24` | PyPI |
| Frontend | `@lambda-development/erp-core@^0.1.24` | npm |
...
```
lambda-erp-example/
  pyproject.toml          # lambda-erp==0.1.24  (the backend core)
  ...
  frontend/
    package.json          # @lambda-development/erp-core ^0.1.24 + its peers
