...
|-------|-----------|------|
| Backend | `lambda-erp==0.6.13` | PyPI |
| Frontend | `@lambda-development/erp-core@^0.6.13` | npm |
...
```
lambda-erp-example/
  pyproject.toml          # lambda-erp==0.6.13  (the backend core)
  ...
  frontend/
    package.json          # @lambda-development/erp-core ^0.6.13 + its peers
