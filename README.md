...
|-------|-----------|------|
| Backend | `lambda-erp==0.1.25` | PyPI |
| Frontend | `@lambda-development/erp-core@^0.1.25` | npm |
...
```
lambda-erp-example/
  pyproject.toml          # lambda-erp==0.1.25  (the backend core)
  ...
  frontend/
    package.json          # @lambda-development/erp-core ^0.1.25 + its peers
