...
|-------|-----------|------|
| Backend | `lambda-erp==0.1.20` | PyPI |
| Frontend | `@lambda-development/erp-core@^0.1.20` | npm |
...
```
lambda-erp-example/
  pyproject.toml          # lambda-erp==0.1.20  (the backend core)
  ...
  frontend/
    package.json          # @lambda-development/erp-core ^0.1.20 + its peers
