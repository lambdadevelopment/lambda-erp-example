...
|-------|-----------|------|
| Backend | `lambda-erp==0.1.28` | PyPI |
| Frontend | `@lambda-development/erp-core@^0.1.28` | npm |
...
```
lambda-erp-example/
  pyproject.toml          # lambda-erp==0.1.28  (the backend core)
  ...
  frontend/
    package.json          # @lambda-development/erp-core ^0.1.28 + its peers
