...
|-------|-----------|------|
| Backend | `lambda-erp==0.1.19` | PyPI |
| Frontend | `@lambda-development/erp-core@^0.1.19` | npm |
...
```
lambda-erp-example/
  pyproject.toml          # lambda-erp==0.1.19  (the backend core)
  ...
  frontend/
    package.json          # @lambda-development/erp-core ^0.1.19 + its peers
