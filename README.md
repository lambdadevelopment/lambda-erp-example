...
|-------|-----------|------|
| Backend | `lambda-erp==0.1.21` | PyPI |
| Frontend | `@lambda-development/erp-core@^0.1.21` | npm |
...
```
lambda-erp-example/
  pyproject.toml          # lambda-erp==0.1.21  (the backend core)
  ...
  frontend/
    package.json          # @lambda-development/erp-core ^0.1.21 + its peers
