...
|-------|-----------|------|
| Backend | `lambda-erp==0.2.1` | PyPI |
| Frontend | `@lambda-development/erp-core@^0.2.1` | npm |
...
```
lambda-erp-example/
  pyproject.toml          # lambda-erp==0.2.1  (the backend core)
  ...
  frontend/
    package.json          # @lambda-development/erp-core ^0.2.1 + its peers
